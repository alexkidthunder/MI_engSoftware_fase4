...
INSERT INTO permissoes VALUES	
	...
	(DEFAULT,'Alterar permissão'),
	(DEFAULT,'Alterar atribuição'),
	(DEFAULT,'Visualizar log'),
	(DEFAULT,'Backup'),
	(DEFAULT,'Cadastrar paciente'),
	(DEFAULT,'Cadastrar prontuario'),
	(DEFAULT,'Cadastrar Agendamento'),
	(DEFAULT,'Cadastrar Medicamento'),
	(DEFAULT,'Cadastrar plantonista'),
	(DEFAULT,'Listar Pacientes'),
	(DEFAULT,'Listar agendamentos'),
	(DEFAULT,'Listar Enfermeiros'),
	(DEFAULT,'Visualizar plantonista'),
	(DEFAULT,'Adicionar ocorrência'),
	(DEFAULT,'Cadastrar CID'),
	(DEFAULT,'Baixa de agendamento'),
	(DEFAULT,'Visualizar Ocorrência');
