...
ALTER TABLE agendamentos
  ...
  ADD CONSTRAINT agendamento_ibfk_2 FOREIGN KEY (CPF_usuario) REFERENCES responsaveis (CPF), /*Cria chave estrangeira fazendo referencia a responsavel*/
...
ALTER TABLE ocorrencias
  ...
  ADD CONSTRAINT ocorrencia_ibfk_2 FOREIGN KEY (CPF) REFERENCES responsaveis (CPF); /*Cria chave estrangeira fazendo referencia a Usuario*/
