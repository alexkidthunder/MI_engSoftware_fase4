            ...
            <form action="/alterarPermissao" method="get">
                ...
                @if (isset($p))
                    <div class="row">
                        <!--Inicio da permissão-->
                        @if (isset($p[1]))
                            <div class="col-lg-13 content-center" name="adm">
                    ...
                    <div class="row">
                        @if (isset($p[16]))
                            <!--Inicio da permissão-->
                            <div class="col-lg-13 content-center" name="paciente">
                    ...
                    <div class="row">
                        <!--Inicio da permissão-->
                        @if (isset($p[28]))
                            <div class="col-lg-13 content-center" name="gerenciamento_hospitalar">
                        ...
                        <!--Inicio da permissão-->
                        @if (isset($p[7]))
                            <div class="col-lg-13 content-center" name="gerenciamento">
