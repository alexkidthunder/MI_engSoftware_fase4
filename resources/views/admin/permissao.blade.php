                ...
                @if (isset($p))
                    <div class="row">
                        ...
                        @if (isset($p[1]))
                            <div class="col-lg-13 content-center">
                                <input type="checkbox" id="adm" name="p1" {{ $p[1] }}><br>
                        ...
                        @if (isset($p[2]))
                            <div class="col-lg-13 content-center">
                                <input type="checkbox" id="adm" name="p2" {{ $p[2] }}><br>
                        ...
                        @if (isset($p[3]))
                            <div class="col-lg-13 content-center">
                                <input type="checkbox" id="adm" name="p3" {{ $p[3] }}><br>
                        ...
                        @if (isset($p[4]))
                            <div class="col-lg-13 content-center">
                                <input type="checkbox" id="adm" name="p4" {{ $p[4] }}><br>
                        ...
                        @if (isset($p[5]))
                            <div class="col-lg-13 content-center">
                                <input type="checkbox" id="adm" name="p5" {{ $p[5] }}><br>
                        ...
                        @if (isset($p[6]))
                            <!--Inicio da permissão-->
                            <div class="col-lg-13 content-center">
                                <input type="checkbox" id="adm" name="p6" {{ $p[6] }}><br>
                    ...
                    <div class="row">
                        @if (isset($p[16]))
                            <!--Inicio da permissão-->
                            <div class="col-lg-13 content-center">
                                <input type="checkbox" id="paciente" name="p16" {{ $p[16] }}><br>
                        ...
                        @if (isset($p[17]))
                            <div class="col-lg-13 content-center">
                                <input type="checkbox" id="paciente" name="p17" {{ $p[17] }}><br>
                        ...
                        @if (isset($p[34]))
                            <div class="col-lg-13 content-center">
                                <input type="checkbox" id="paciente" name="p34" {{ $p[34] }}><br>
                        ...
                        @if (isset($p[18]))
                            <div class="col-lg-13 content-center">
                                <input type="checkbox" id="paciente" name="p18" {{ $p[18] }}><br>
                        ...
                        @if (isset($p[19]))
                            <div class="col-lg-13 content-center">
                                <input type="checkbox" id="paciente" name="p19" {{ $p[19] }}><br>
                        ...
                        @if (isset($p[9]))
                            <div class="col-lg-13 content-center">
                                <input type="checkbox" id="paciente" name="p9" {{ $p[9] }}><br>
                        ...
                        @if (isset($p[10]))
                            <div class="col-lg-13 content-center">
                                <input type="checkbox" id="paciente" name="p10" {{ $p[10] }}><br>
                        ...
                        @if (isset($p[26]))
                            <div class="col-lg-13 content-center">
                                <input type="checkbox" id="paciente" name="p26" {{ $p[26] }}><br>
                        ...
                        @if (isset($p[27]))
                            <div class="col-lg-13 content-center">
                                <input type="checkbox" id="paciente" name="p27" {{ $p[27] }}><br>
                        ...
                        @if (isset($p[31]))
                            <div class="col-lg-13 content-center">
                                <input type="checkbox" id="paciente" name="p31" {{ $p[31] }}><br>
                        ...
                        @if (isset($p[32]))
                            <div class="col-lg-13 content-center">
                                <input type="checkbox" id="paciente" name="p32" {{ $p[32] }}><br>
                        ...
                        @if (isset($p[33]))
                            <div class="col-lg-13 content-center">
                                <input type="checkbox" id="paciente" name="p33" {{ $p[33] }}><br>
                    ...
                    <div class="row">
                        ...
                        @if (isset($p[28]))
                            <div class="col-lg-13 content-center">
                                <input type="checkbox" id="gerenciamento_hospitalar" name="p28" {{ $p[28] }}><br>
                        ...
                        @if (isset($p[29]))
                            <div class="col-lg-13 content-center">
                                <input type="checkbox" id="gerenciamento_hospitalar" name="p29" {{ $p[29] }}><br>
                        ...
                        @if (isset($p[8]))
                            <div class="col-lg-13 content-center">
                                <input type="checkbox" id="gerenciamento_hospitalar" name='p8' {{ $p[8] }}><br>
                        ...
                        @if (isset($p[35]))
                            <div class="col-lg-13 content-center">
                                <input type="checkbox" id="gerenciamento_hospitalar" name="p35" {{ $p[35] }}><br>
                        ...
                        @if (isset($p[7]))
                            <div class="col-lg-13 content-center">
                                <input type="checkbox" id="gerenciamento" name="p7" {{ $p[7] }}><br>
                        ...
                        @if (isset($p[30]))
                            <div class="col-lg-13 content-center">
                                <input type="checkbox" id="gerenciamento" name="p30" {{ $p[30] }}><br>
                        ...
                        @if (isset($p[13]))
                            <div class="col-lg-13 content-center">
                                <input type="checkbox" id="gerenciamento" name="p13" {{ $p[13] }}><br>
                        ...
                        @if (isset($p[12]))
                            <div class="col-lg-13 content-center">
                                <input type="checkbox" id="gerenciamento" name="p12" {{ $p[12] }}><br>
                        ...
                        @if (isset($p[15]))
                            <div class="col-lg-13 content-center">
                                <input type="checkbox" id="gerenciamento" name="p15" {{ $p[15] }}><br>
                    ...
                    @if (isset($p[11]))
                        <div class="col-lg-13 content-center">
                            <input type="checkbox" id="agendamento" name="p11" {{ $p[11] }}><br>
                    ...
                    <!--Inicio da permissão-->
                        @if (isset($p[20]))
                            <div class="col-lg-13 content-center">
                                <input type="checkbox" id="agendamento" name="p20" {{ $p[20] }}><br>
                        ...
                        @if (isset($p[14]))
                            <div class="col-lg-13 content-center">
                                <input type="checkbox" id="agendamento" name="p14" {{ $p[14] }}><br>
                        ...
                        @if (isset($p[21]))
                            <div class="col-lg-13 content-center">
                                <input type="checkbox" id="agendamento" name="p21" {{ $p[21] }}><br>
                        ...
                        @if (isset($p[22]))
                            <div class="col-lg-13 content-center">
                                <input type="checkbox" id="agendamento" name="p22" {{ $p[22] }}><br>
                        ...
                        @if (isset($p[24]))
                            <div class="col-lg-13 content-center">
                                <input type="checkbox" id="agendamento" name="p24" {{ $p[24] }}><br>
                        ...
                        @if (isset($p[25]))
                            <div class="col-lg-13 content-center">
                                <input type="checkbox" id="agendamento" name="p25" {{ $p[25] }}><br>
                        ...
                        @if (isset($p[23]))
                            <div class="col-lg-13 content-center transition-1s">
                                <input type="checkbox" id="agendamento" name="p23" {{ $p[23] }}><br>
