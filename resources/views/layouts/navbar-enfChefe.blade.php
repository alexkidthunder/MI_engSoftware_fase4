                ...
                <nav class="nav d-none d-lg-block">
                    <ul>
                        ...
                        <li class="drop-down title-nav"><a>AGENDAMENTOS E<br> MEDICAMENTOS <i
                            ...
                            <ul>
                                <li><a href="{{ route('cadastroAgendamento') }}">Cadastro de
                                        agendamentos</a></li>
                                <li><a href="{{ route('listaAgendamentos') }}">Listagem de agendamentos</a>
                                </li>
                                <li><a href="{{ route('cadastroMedicamento') }}">Cadastro de
                                        medicamentos</a></li>
                                <li><a href="{{ route('listaMedicamento') }}">Medicamentos cadastados</a>
                                </li>
                                <li><a href="{{ route('responsaveis') }}">Responsáveis por aplicação</a>
                                </li>
                            </ul>
                        </li>
